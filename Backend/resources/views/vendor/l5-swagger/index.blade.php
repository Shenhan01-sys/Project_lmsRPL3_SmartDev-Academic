...
<script>
    window.onload = function() {
        ...
        // --- BAGIAN INI KITA ABAIKAN SAJA (BIAR GAK BINGUNG) ---
        // const urls = [];
        ...
        const ui = SwaggerUIBundle({
            ...
            // Ganti 'urls: urls' menjadi 'url' (string langsung)
            // urls: urls,  <-- HAPUS ATAU KOMENTARI BARIS INI
            
            url: "https://portohansgunawan.my.id/api-docs/api-docs.json", // <--- INI KUNCINYA!
