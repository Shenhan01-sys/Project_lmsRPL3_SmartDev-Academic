...
class AttendanceRecord extends Model
{
    ...
    {
        return $query->whereIn('status', ['sick', 'permission'])
     ...
     */
    public function markAsPermission(string $documentPath, string $notes = null): void
    {
        $this->update([
            'status' => 'permission',
            'supporting_doc_path' => $documentPath,
    ...
    {
        return in_array($this->status, ['sick', 'permission']) && !$this->reviewed_by;
    }
